...
const Header: React.FC = () => {
 ...
 const navItems = [
    { path: "/intro/overview", label: "Overview" },
    { path: "/intro/useCases", label: "Use Cases" },
    { path: "/intro/team", label: "Team" },
    { path: "/intro/InfrastructureModel", label: "Infrastructure Model" },
    { path: "/intro/roadmap", label: "Roadmap" },
  ];
