...
const Header: React.FC = () => {
  ...
  const location = useLocation();
    ...
    const navItems = [
    { path: "/validators/N1validator", label: "N1 Validator" },
    { path: "/validators/N2validatorplus", label: "N2 Validator Plus" },
    { path: "/validators/Validatorrequirements", label: "Validator Requirements" },
    { path: "/validators/validatordeploymentworkflow", label: "Validator Deployment Workflow" },
    { path: "/validators/validatorrewards", label: "Validator Rewards" },
    { path: "/validators/validatormonitoring", label: "Validator Monitoring" },
    { path: "/validators/validatorsecurity", label: "Validator Security" },
  ];
